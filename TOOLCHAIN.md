...
| wasm target | `wasm32-unknown-unknown` | rust-toolchain targets (contracts); `wasm32-wasip1` added ad hoc for the contract test runner |
| Node | 22.x | CI matrix |
| pnpm | 10.x | CI (`pnpm/action-setup`) |
