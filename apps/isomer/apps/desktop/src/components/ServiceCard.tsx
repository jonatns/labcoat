        ...
        <div className="glass rounded-xl p-5 hover:border-zinc-500 transition-colors">
            ...
            <div className="space-y-3">
                <div className="grid grid-cols-2 gap-4 text-sm mt-2">
                    <div>
                        <span className="text-zinc-500 block mb-1">Port</span>
                        <button
                            onClick={() => copyToClipboard(service.port.toString())}
                            className="text-zinc-300 font-mono hover:text-white transition-colors flex items-center gap-2 group"
                    ...
                    <div>
                        <span className="text-zinc-500 block mb-1">PID</span>
