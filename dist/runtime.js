...
export async function setup() {
    ...
    async function deploy(contractName) {
        return deployContract(contractName, account, signer, provider, accountUtxos);
    }
    ...
    async function execute(contractName, methodName, args = []) {
        return executeContract(contractName, methodName, args, account, signer, provider, accountUtxos);
    }
